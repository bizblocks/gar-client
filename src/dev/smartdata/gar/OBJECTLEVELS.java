 ...
 *       &lt;sequence>
 *         &lt;element name="OBJECTLEVEL" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
...
@XmlRootElement(name = "OBJECTLEVELS")
public class OBJECTLEVELS {

    @XmlElement(name = "OBJECTLEVEL", required = true)
    protected List<OBJECTLEVELS.OBJECTLEVEL> objectlevel;
     ...
     * This is why there is not a <CODE>set</CODE> method for the objectlevel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOBJECTLEVEL().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OBJECTLEVELS.OBJECTLEVEL }
     * 
     * 
     */
    public List<OBJECTLEVELS.OBJECTLEVEL> getOBJECTLEVEL() {
        if (objectlevel == null) {
            objectlevel = new ArrayList<OBJECTLEVELS.OBJECTLEVEL>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class OBJECTLEVEL {
